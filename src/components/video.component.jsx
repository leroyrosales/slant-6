...
export default function Video({ video }) {
  ...
  return (
    <article className="video-card bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 transition-all duration-500 hover:scale-110 hover:cursor-pointer">
